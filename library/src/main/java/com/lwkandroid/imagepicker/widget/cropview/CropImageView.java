...
package com.lwkandroid.imagepicker.widget.cropview;
...
public class CropImageView extends FrameLayout
{
    ...
    public CropImageView(Context context, AttributeSet attrs)
    {
        ...
        View v = inflater.inflate(R.layout.layout_crop_view_container, this, true);

        mImageView = v.findViewById(R.id.img_crop_content);
     ...
     */
    private void setLoadingStateVisibility()
    {
        boolean visible =
                mShowProgressBar
                        && (mBitmap == null && mBitmapLoadingWorkerTask != null
                        || mBitmapCroppingWorkerTask != null);
        mLoadingView.setVisibility(visible ? VISIBLE : INVISIBLE);
    }
